            ...
            <div class="page-wrapper">
                <div class="form-group row">
                    <div class="col-md-12" style="margin-right: 873px;">
                        <a class="btn waves-effect waves-light btn-grd-primary" href="{{url('Kobe/video-management/list?page='.request('page'))}}">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-block">
                                    <form id="" method="post" action="{{route('admin.home.section3.edit', ['id'=>base64_encode($edit->id), 'page'=>request('page')])}}" novalidate enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <video width="150" height="150" controls>
                                                    <source src="{{asset('public/storage/uploads/home-section3/'.$edit->video ?? '')}}">
                                                </video>
                                            </div>
                                        </div>
                                        <div class="form-group row">
