            ...
            <div class="page-wrapper">
                <div class="form-group row">
                    <div class="col-md-12" style="margin-right: 873px;">
                        <a class="btn waves-effect waves-light btn-grd-primary" href="{{route('admin.home.section3.list')}}">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-block">
                                    <form id="" method="post" action="{{route('admin.home.section3.add')}}" novalidate enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group row">
