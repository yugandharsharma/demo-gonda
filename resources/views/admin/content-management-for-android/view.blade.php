                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-block">
                                    <form id="" method="post"
                                        action="{{ route('admin.content.management.view.android', ['id' => base64_encode($view->id), 'page' => request('page')]) }}"
                                        novalidate>
                                        @csrf
                ...
                <div class="form-group row">
                    <div class="col-md-12" style="text-align: center">
                        <a class="btn waves-effect waves-light btn-grd-primary"
                            href="{{ url('Kobe/content-management-for-android/list?page=' . request('page')) }}">
