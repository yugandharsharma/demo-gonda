                                                ...
                                                <td>
                                                    @if ($data->type == 2)
                                                        <a class="btn waves-effect waves-light btn-grd-info"
                                                            href="{{ route('admin.content.management.view.android', ['id' => base64_encode($data->id), 'page' => request('page')]) }}"
                                                            style="padding: 4px;">
                                                            <i class="fa fa-eye"></i> View
                                                        </a>
                                                        <a class="btn waves-effect waves-light btn-grd-success"
                                                            href="{{ route('admin.content.management.edit.android', ['id' => base64_encode($data->id), 'page' => request('page')]) }}"
                                                            style="padding: 4px;">
