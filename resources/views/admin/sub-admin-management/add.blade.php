            ...
            <div class="page-wrapper">
                <div class="form-group row">
                    <div class="col-md-12" style="margin-right: 873px;">
                        <a class="btn waves-effect waves-light btn-grd-primary" href="{{route('admin.sub.admin.management.list')}}">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-block">
                                    <form id="sub-admin-management-form" method="post" action="{{route('admin.sub.admin.management.add')}}" novalidate>
                                        @csrf
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control @error('mobile_number') is-invalid @enderror" id="mobile_number" name="mobile_number" placeholder="Mobile Number" value="{{ old('mobile_number') }}">
                                                @error('mobile_number')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                    </span>
                                                ...
                                                @forelse($permission_data as $data)
                                                    <tr>
                                                        <td>
                                                            <div class="border-checkbox-section">
                                                                <div class="border-checkbox-group border-checkbox-group-info">
                                                                    <input class="border-checkbox" type="checkbox" id="{{$data->slug}}" name="module_name[]" value="{{$data->id}}" onclick="permissionCheckboxToggle('{{$data->slug}}')">
                                                        ...
                                                        <td>
                                                            <div class="border-checkbox-section">
                                                                <div class="border-checkbox-group border-checkbox-group-primary not-allow">
                                                                    <input class="border-checkbox " type="checkbox" id="add_{{$data->slug}}" name="add[]" value="{{$data->id}}" disabled>
                                                        ...
                                                        <td>
                                                            <div class="border-checkbox-section ">
                                                                <div class="border-checkbox-group border-checkbox-group-success">
                                                                    <input class="border-checkbox not-allow" type="checkbox" id="edit_{{$data->slug}}" name="edit[]" value="{{$data->id}}" disabled>
                                                        ...
                                                        <td>
                                                            <div class="border-checkbox-section">
                                                                <div class="border-checkbox-group border-checkbox-group-danger">
                                                                    <input class="border-checkbox not-allow" type="checkbox" id="delete_{{$data->slug}}" name="delete[]" value="{{$data->id}}" disabled>
                                                        ...
                                                        <td>
                                                            <div class="border-checkbox-section">
                                                                <div class="border-checkbox-group border-checkbox-group-info">
                                                                    <input class="border-checkbox not-allow" type="checkbox" id="view_{{$data->slug}}" name="view[]" value="{{$data->slug}}" disabled>
