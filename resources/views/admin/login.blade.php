...
<body themebg-pattern="theme1">
    ...
    <section class="login-block">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                   <form class="md-float-material form-material" id="login-form" method="post" action="{{ route('admin.login') }}"  autocomplete="off">
                            @csrf
                                    ...
                                    <div class="row m-t-25 text-left">
                                        <div class="col-12">
                                            <div class="forgot-phone text-right f-right">
                                                <a href="{{ route('admin.forget.password.view') }}" class="text-right f-w-600"> Forgot Password?</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="submit" class="btn waves-effect waves-light btn-grd-primary btn-md btn-block text-center m-b-20">
