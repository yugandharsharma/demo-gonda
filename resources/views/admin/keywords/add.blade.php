                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-block">
                                    <form id="keyword-form" method="post" action="{{ route('admin.keyword.add') }}"
                                        novalidate>
                                        @csrf
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text"
                                                    ...
                                                    name="keyword" placeholder="Keyword" value="{{ old('keyword') }}">
                                                @error('keyword')
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="question"
                                                    ...
                                                    id="question" rows="10" cols="80">{{ old('question') }}</textarea>
                                                @error('question')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
