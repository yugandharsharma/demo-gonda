            ...
            <div class="page-wrapper">
                <div class="form-group row">
                    <div class="col-md-12" style="margin-right: 873px;">
                        <a class="btn waves-effect waves-light btn-grd-primary" href="{{route('admin.user.list')}}">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-block">
                                    <form id="user-add-form" method="post" action="{{route('admin.user.add')}}" novalidate>
                                        @csrf
                                        <div class="form-group row">
