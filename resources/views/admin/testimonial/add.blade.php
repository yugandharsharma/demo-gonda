            ...
            <div class="page-wrapper">
                <div class="form-group row">
                    <div class="col-md-12" style="margin-right: 873px;">
                        <a class="btn waves-effect waves-light btn-grd-primary" href="{{route('admin.testimonial.list')}}">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-block">
                                    <form id="testimonial-add-form" method="post" action="{{route('admin.testimonial.add')}}" novalidate enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control @error('designation') is-invalid @enderror" id="designation" name="designation" placeholder="Designation" value="{{old('designation')}}">
                                                @error('designation')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                    </span>
