            ...
            <div class="page-wrapper">
                <div class="form-group row">
                    <div class="col-md-12" style="margin-right: 873px;">
                        <a class="btn waves-effect waves-light btn-grd-primary" href="{{url('Kobe/intro-screen/list?page='.request('page'))}}">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-block">
                                    <form id="content-management-edit-form" method="post" action="{{route('admin.intro.screen.edit',['id'=>base64_encode($edit->id), 'page'=>request('page')])}}" novalidate enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <img src="{{asset('public/storage/uploads/intro-screen/'.$edit->image ?? '')}}" style="width: 50px; height: 50px">
                                            </div>
                                        </div>
